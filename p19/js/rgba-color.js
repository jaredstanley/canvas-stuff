...
RGBAColor.prototype.setFromHSV = function(h, s, v, alpha) {
    ...
    //console.log(this.r+" "+this.b+" "+this.c);
}
...
function randColor(r, g, b, a){
    ...
    var output = cObj.r+","+cObj.g+","+cObj.b+","+cObj.alpha;
    return "rgba("+output+")";
}
...
function countIt(){
  ...
  main_ctx.fillStyle="#666666";
  main_ctx.font="30px sans-serif";
  main_ctx.fillText(":"+icount*numberOfPoints+":", 110, 66);
icount+=1;
